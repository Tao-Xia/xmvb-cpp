...
struct HFInfo
{
    ...
    /**
     * @brief information of background's charge
     *        This is used for QM/MM calculation and DFT/DFTB calculation
     */
    struct
    {
        int charge_num;            // the number of charge
        Vector charge_value;       // the coordination and value of charge charge_num * 4
        Matrix ev_matrix;          // the matrix of external charge
        Vector e_ev, e_nv, e_tolv; // the energy of electrons-external charge, nucleus-external charge and the summation
        Vector ev_grad;            // the gradient of external charge's coordinations
    } *background_charge;
    /**
