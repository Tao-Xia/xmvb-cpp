...
echo "========================================"
$EXE $TEST/F2.xmi --optimizer-backend nonredundant_truncated_newton --nonredundant-truncated-newton-hvp-mode exact_ctx --max-iterations 50
...
echo "========================================"
export XMVB_CPP_USE_CAYLEY_RETRACTION=1
$EXE $TEST/MnF2_tnhvp.xmi --optimizer-backend nonredundant_truncated_newton --nonredundant-truncated-newton-hvp-mode exact_ctx --max-iterations 500
