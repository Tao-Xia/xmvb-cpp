#define build_shidx xmvb_cpp_build_shidx
#define cal_2eint xmvb_cpp_cal_2eint
#define cal_2eint_ xmvb_cpp_cal_2eint_
#define int_gg3_shell_direct xmvb_cpp_int_gg3_shell_direct
#define int_gg3_shell_direct_ xmvb_cpp_int_gg3_shell_direct_
#define cal_fock_vb_direct xmvb_cpp_cal_fock_vb_direct
#define cal_rfock_vb_direct_ xmvb_cpp_cal_rfock_vb_direct_
#define cal_ufock_vb_direct_ xmvb_cpp_cal_ufock_vb_direct_
