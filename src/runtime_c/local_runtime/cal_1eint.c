#define cal_overlap_mat xmvb_cpp_cal_overlap_mat
#define cal_dip_mat xmvb_cpp_cal_dip_mat
#define cal_1eint xmvb_cpp_cal_1eint
#define cal_1eint_ xmvb_cpp_cal_1eint_
#define cal_pcf_int xmvb_cpp_cal_pcf_int
#define cal_1egrad_cint xmvb_cpp_cal_1egrad_cint
#define cal_nuc_grad xmvb_cpp_cal_nuc_grad
#define cal_dipole_int xmvb_cpp_cal_dipole_int
