...
// out of vbscf_optimizer.cpp's anonymous namespace so that the objective
...
// promoted out of vbscf_optimizer.cpp's anonymous namespace so that
// VbScfObjective (now in its own TU) can call them. They remain internal
