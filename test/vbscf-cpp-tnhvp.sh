...
Defaults:
  ...
  optimizer backend    OPTIMIZER_BACKEND=nonredundant_truncated_newton
...
Examples:
  ...
  sbatch -c 32 /path/to/vbscf-cpp-tnhvp.sh 240_VBSCF.xmi
  sbatch -c 32 /path/to/vbscf-cpp-tnhvp.sh /path/to/input.xmi
